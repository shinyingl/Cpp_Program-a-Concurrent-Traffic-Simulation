...
![traffic](data/traffic.png)

This is the project for the fourth course in the [Udacity C++ Nanodegree Program](https://www.udacity.com/course/c-plus-plus-nanodegree--nd213): Concurrency. The starter code can be found [here.](https://github.com/udacity/CppND-Program-a-Concurrent-Traffic-Simulation)

The project simulates vehicles to enter intersections following the traffic signals. The thread-safe communication protocal is implemented with concurrency in C++.
...
The project finished the following tasks. The traffic lights are cycling through red and green in an interval of 4 to 6 sec. The viecles will wait for the green light signal to enter the intersections.
